...
MODEL_DIR = "models"
RESULTS_DIR = "results/rf_walk_stairs/masked_open_set"
...
def build_or_train_pipeline(X_train, y_train):
    params_path = os.path.join(MODEL_DIR, "best_params_rf_walk_stairs.json")
...
def run_analysis(valid_subs, incomplete_subs):
    ...
    plt.title('Masked Open Set ROC - Random Forest (Walk/Stairs)', fontsize=14, pad=15)
