...
RESULTS_DIR = "results/alt_models/hgb_walk_stairs/no_flip/closed_set"
MODEL_NAME = "hgb_walk_stairs_closed_set_no_flip.joblib"
PARAMS_FILE = os.path.join(MODEL_DIR, 'best_params_hgb_walk_stairs_closed_set_no_flip.json')
