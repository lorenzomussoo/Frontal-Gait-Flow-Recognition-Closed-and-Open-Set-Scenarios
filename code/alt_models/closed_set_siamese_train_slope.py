...
MODEL_DIR = "models"
RESULTS_DIR = "results/siamese_slope/closed_set"
...
def load_data():
    console.print(Panel.fit(f"[bold magenta]Loading SLOPE Dataset for SIAMESE NETWORK: {FEATURES_ROOT}[/bold magenta]"))
...
def train_and_evaluate():
    ...
    console.print(Panel("[bold green]Starting SIAMESE Training Loop (Slope IMU)...[/bold green]"))
    ...
    if SAVE_RESULTS:
        with open(os.path.join(RESULTS_DIR, "metrics_report.txt"), "w") as f:
            f.write("=== FINAL REPORT: SIAMESE NETWORK (SLOPE IMU) ===\n\n--- CLASSIFICATION REPORT ---\n")
        ...
        plt.title('Cumulative Match Characteristic (CMC) - Siamese Slope')
        ...
        plt.title('Confusion Matrix - Siamese Slope')
        ...
        torch.save(model.state_dict(), os.path.join(MODEL_DIR, "siamese_slope_closed_set.pth"))
