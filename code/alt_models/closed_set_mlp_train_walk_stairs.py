...
MODEL_DIR = "models"
RESULTS_DIR = "results/mlp_walk_stairs/closed_set"
MODEL_NAME = "mlp_walk_stairs_closed_set.joblib"
PARAMS_FILE = os.path.join(MODEL_DIR, 'best_params_mlp_walk_stairs_closed_set.json')
