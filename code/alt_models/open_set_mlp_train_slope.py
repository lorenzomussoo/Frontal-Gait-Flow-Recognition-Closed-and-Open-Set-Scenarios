...
RESULTS_DIR = "results/alt_models/mlp_slope/open_set"
...
def main():
    console.print(Panel.fit("[bold magenta]OPEN SET PROTOCOL: MLP (Slope)[/bold magenta]"))
    ...
    model_name = "mlp_slope_closed_set.joblib" if USE_ALL_VALID_AS_KNOWN else "mlp_slope_open_set.joblib"
    params_name = "best_params_mlp_slope_closed_set.json" if USE_ALL_VALID_AS_KNOWN else "best_params_mlp_slope_open_set.json"
    ...
    plt.title('Watchlist ROC (Open Set) - MLP Slope')
    ...
    with open(os.path.join(RESULTS_DIR, f"open_set_report{suffix}.txt"), "w") as f:
        f.write("========================================================\n")
        f.write(" OPEN SET WATCHLIST REPORT: MLP Slope\n")
        f.write("========================================================\n")
