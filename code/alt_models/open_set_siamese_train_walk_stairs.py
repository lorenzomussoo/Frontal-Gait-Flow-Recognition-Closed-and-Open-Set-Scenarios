...
RESULTS_DIR = "results/alt_models/siamese_walk_stairs/open_set"
...
def main():
    console.print(Panel.fit("[bold cyan]OPEN SET PROTOCOL: Siamese (Walk/Stairs)[/bold cyan]"))
    ...
    model_name = "siamese_walk_stairs_closed_set.pth" if USE_ALL_VALID_AS_KNOWN else "siamese_walk_stairs_open_set.pth"
    ...
    plt.title('Watchlist ROC (Open Set) - Siamese Walk/Stairs')
    ...
    with open(os.path.join(RESULTS_DIR, f"open_set_report{suffix}.txt"), "w") as f:
        f.write("========================================================\n")
        f.write(" OPEN SET WATCHLIST REPORT: Siamese Walk/Stairs\n")
        f.write("========================================================\n")
