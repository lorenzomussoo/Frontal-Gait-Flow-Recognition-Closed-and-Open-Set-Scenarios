...
def build_rf_pipeline():
    params_file = os.path.join(MODEL_DIR, 'best_params_rf_walk_stairs_closed_set_no_flip.json')
...
def main():
    rf_model_path = os.path.join(MODEL_DIR, "rf_walk_stairs_closed_set_no_flip.joblib")
    rf_results_dir = "results/rf_walk_stairs/no_flip/closed_set"
